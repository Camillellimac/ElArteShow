...
const galleryContent = {
  botanic: [
    { id: 1, src: botanic1, alt: "botanic1" },
    { id: 2, src: botanic2, alt: "botanic2" },
    { id: 3, src: botanic3, alt: "botanic3" },
    { id: 4, src: botanic4, alt: "botanic4" },
    { id: 1, src: botanic1, alt: "botanic1" },
    { id: 2, src: botanic2, alt: "botanic2" },
    { id: 3, src: botanic3, alt: "botanic3" },
    { id: 4, src: botanic4, alt: "botanic4" },
  ...
  ocean: [
    { id: 1, src: ocean1, alt: "ocean1" },
    { id: 2, src: ocean2, alt: "ocean2" },
    { id: 3, src: ocean3, alt: "ocean3" },
    { id: 4, src: ocean4, alt: "ocean4" },
  ],
  nature: [
    { id: 1, src: nature1, alt: "nature1" },
    { id: 2, src: nature2, alt: "nature2" },
    { id: 3, src: nature3, alt: "nature3" },
    { id: 4, src: nature4, alt: "nature4" },
  ],
